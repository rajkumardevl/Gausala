...
<div class="container-fluid">
    <h1 class="text-center mt-3 list-group-item-primary py-4 rounded border shadow">Goshala Departments</h1>
    <hr class="my-4">
    <div class="row">
        <div class="col-md-6 m-0 p-0">
            <div class="depart_image">
                <img class="img-fluid border rounded shadow m-0 p-0" src="images/IMG_0918.JPG" alt="">
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="depart_image">
                <img class="img-fluid border rounded shadow m-0 p-0" src="images/IMG_0947.JPG" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 m-0 p-0">
            <div class="depart_image">
                <img class="img-fluid border rounded shadow m-0 p-0" src="images/IMG_1072.JPG" alt="">
            </div>
        </div>
        <div class="col-md-6">
            <div class="depart_contant ps-4 pt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="depart_image">
                <img class="img-fluid border rounded shadow m-0 p-0" src="images/IMG_1089.JPG" alt="">
            </div>
        </div>
    </div>
